...
class UserModelTestCase(unittest.TestCase):
  ...
  def test_password_hashing(self):
    u = User(name="Jane Doe", email="janed@codingtemple.com", password="123456")
  ...
  def test_follow(self):
    u1 = User(name="Jane Doe", email="janed@codingtemple.com", password="123456")
    u2 = User(name="John Doe", email="johnd@codingtemple.com", password="1234567")
  ...
  def test_follow_posts(self):
    ...
    p3 = Post(body="some text for another post", user_id=u3.id)
    p4 = Post(body="some text for another post", user_id=u4.id)
    db.session.add_all([p1, p2, p4, p4])
    db.session.commit()
